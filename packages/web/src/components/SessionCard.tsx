            ...
            <div className="session-card__footer-actions">
              {onReview ? (
                <button
                  ...
                  aria-label={t("session.requestReview")}
                >
                  <svg
                    className="session-card__control-icon"
                    fill="none"
                  ...
                  {requestingReview ? t("session.reviewQueued") : t("session.review")}
                </button>
              ) : null}
              <button
                onClick={(e) => {
            ...
            !isTerminal && (
              <div className="session-card__footer-actions">
                ...
                <button
                  ...
                  aria-label={
                    killConfirming ? t("session.confirmTerminate") : t("session.terminate")
                  }
                  className={cn(
